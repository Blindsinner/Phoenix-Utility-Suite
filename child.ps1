...
$DownloadURL = 'https://raw.githubusercontent.com/Blindsinner/Phoenix-Windows-Utility-Suite/PX.cmd'
$DownloadURL2 = 'https://raw.githubusercontent.com/Blindsinner/Phoenix-Windows-Utility-Suite/PX.cmd'
